...
{
    public class When_I_tell_the_monster_to_move_in_the_LEFT_direction : AAATest
    {
        ...
        {
            _monster.Move(Direction.Left);
        }

        [Test]
        public void The_monster_is_positioned_1_more_to_the_left_in_the_WorldMatrix()
        {
